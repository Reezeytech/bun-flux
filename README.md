...
### Step 2: Install bun-flux

After downloading:

1. Find the setup file on your computer. The file usually ends with `.exe`.
2. Double-click the file to start installation.
3. Follow the instructions on the install wizard. Click “Next” through the steps.
